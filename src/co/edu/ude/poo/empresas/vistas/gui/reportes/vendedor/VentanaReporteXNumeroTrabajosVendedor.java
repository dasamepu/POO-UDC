 ...
 * @author david
 */
public class VentanaReporteXNumeroTrabajosVendedor extends javax.swing.JDialog {

    /**
     * Creates new form VentanaReporteVendedor
     */
    public VentanaReporteXNumeroTrabajosVendedor(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaReporteXNumeroTrabajosVendedor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                VentanaReporteXNumeroTrabajosVendedor dialog = new VentanaReporteXNumeroTrabajosVendedor(new javax.swing.JFrame(), true);
