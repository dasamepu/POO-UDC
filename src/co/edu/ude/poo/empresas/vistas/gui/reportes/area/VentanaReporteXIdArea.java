 ...
 * @author david
 */
public class VentanaReporteXIdArea extends javax.swing.JDialog {

    /**
     * Creates new form VentanaReporteArea
     */
    public VentanaReporteXIdArea(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaReporteXIdArea.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                VentanaReporteXIdArea dialog = new VentanaReporteXIdArea(new javax.swing.JFrame(), true);
