 ...
 * @author david
 */
public class VentanaReporteXNombreVendedor extends javax.swing.JDialog {

    /**
     * Creates new form VentanaReporteVendedor
     */
    public VentanaReporteXNombreVendedor(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaReporteXNombreVendedor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                VentanaReporteXNombreVendedor dialog = new VentanaReporteXNombreVendedor(new javax.swing.JFrame(), true);
