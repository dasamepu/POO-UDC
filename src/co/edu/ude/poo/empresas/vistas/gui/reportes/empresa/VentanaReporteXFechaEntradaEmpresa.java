 ...
 * @author david
 */
public class VentanaReporteXFechaEntradaEmpresa extends javax.swing.JDialog {

    /**
     * Creates new form VentanaReporteEmpresa
     */
    public VentanaReporteXFechaEntradaEmpresa(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaReporteXFechaEntradaEmpresa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                VentanaReporteXFechaEntradaEmpresa dialog = new VentanaReporteXFechaEntradaEmpresa(new javax.swing.JFrame(), true);
