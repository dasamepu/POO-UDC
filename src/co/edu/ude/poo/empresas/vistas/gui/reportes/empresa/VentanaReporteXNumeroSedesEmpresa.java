 ...
 * @author david
 */
public class VentanaReporteXNumeroSedesEmpresa extends javax.swing.JDialog {

    /**
     * Creates new form VentanaReporteEmpresa
     */
    public VentanaReporteXNumeroSedesEmpresa(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaReporteXNumeroSedesEmpresa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                VentanaReporteXNumeroSedesEmpresa dialog = new VentanaReporteXNumeroSedesEmpresa(new javax.swing.JFrame(), true);
