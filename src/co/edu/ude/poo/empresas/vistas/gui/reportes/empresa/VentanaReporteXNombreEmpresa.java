 ...
 * @author david
 */
public class VentanaReporteXNombreEmpresa extends javax.swing.JDialog {

    /**
     * Creates new form VentanaReporteEmpresa
     */
    public VentanaReporteXNombreEmpresa(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        Collections.sort(listaEmpresas, new Comparator<Empresa>() {
            ...
            public int compare(Empresa a1, Empresa a2) {
                return a1.getNombre_empresa().compareTo(a2.getNombre_empresa());
            }
        });
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaReporteXNombreEmpresa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                VentanaReporteXNombreEmpresa dialog = new VentanaReporteXNombreEmpresa(new javax.swing.JFrame(), true);
