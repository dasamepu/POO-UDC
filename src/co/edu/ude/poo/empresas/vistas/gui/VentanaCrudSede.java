...
public class VentanaCrudSede extends javax.swing.JDialog {
    Sede sede;
    /**
     * Creates new form VentanaCrudSede
     */
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Formulario Sede");

        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 153, 153)), "Datos de la Sede:", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Arial", 0, 14), new java.awt.Color(0, 102, 204))); // NOI18N
        ...
        EtiquetaCiudad.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        EtiquetaCiudad.setText("CIUDAD DONDE SE LOCALIZA:");

        CampoCiudad.setFont(new java.awt.Font("Liberation Sans", 0, 18)); // NOI18N
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(CampoCiudad, javax.swing.GroupLayout.PREFERRED_SIZE, 297, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(CampoId, javax.swing.GroupLayout.PREFERRED_SIZE, 297, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(26, 26, 26))
        );
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/co/edu/ude/poo/empresas/vistas/iconos/sede.png"))); // NOI18N
    ...
    private void BotonAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotonAgregarActionPerformed
        ...
        String nombre = CampoCiudad.getText();
        //crear un objeto (variable tipo sede)
        Sede sede = new Sede();
        sede.setId(id);
        sede.setCiudad_localiza(nombre);
        //validar si el Map existe
        if(Sede.getSedeBD() == null){
            Sede.setSedeBD(new HashMap<String, Sede>());
        }
        //validar si el Map ya tiene el sede guardada
        if(Sede.getSedeBD().containsKey(id)){
            String msj = "Ya existe el sede con id: " + id;
    ...
    private void BotonBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotonBuscarActionPerformed
        ...
        if(Sede.getSedeBD() == null || Sede.getSedeBD().isEmpty()){
            ...
            //buscar el sede a partir del id
            if(Sede.getSedeBD().containsKey(id)){
                this.sede = Sede.getSedeBD().get(id);
                CampoCiudad.setText(this.sede.getCiudad_localiza());
    ...
    private void BotonEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotonEditarActionPerformed
        ...
        if(CampoId.getText().equals(this.sede.getId()) != true){
        ...
        //validando que el sede sí sea editada
        if(CampoCiudad.getText().equals(this.sede.getCiudad_localiza()) == true){
        ...
        this.sede = Sede.getSedeBD().get(CampoId.getText());
        ...
        //se pregunta si se quiere guardar la informacion
            ...
            if(option == JOptionPane.YES_OPTION){
                ...
                //Cambiar los datos anteriores del sede por los datos nuevos
                this.sede.setCiudad_localiza(String.valueOf(nombre));
    ...
    private void BotonEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotonEliminarActionPerformed
        ...
        String msj = "Seguro desea eliminar el sede?";
    ...
    private void BotonListarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotonListarActionPerformed
        ...
        VentanaReporteSede ventanaReporte = new VentanaReporteSede(new JFrame(), true);
