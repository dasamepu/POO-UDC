...
public class VentanaReporteHolding extends javax.swing.JDialog {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaReporteHolding.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                VentanaReporteHolding dialog = new VentanaReporteHolding(new javax.swing.JFrame(), true);
