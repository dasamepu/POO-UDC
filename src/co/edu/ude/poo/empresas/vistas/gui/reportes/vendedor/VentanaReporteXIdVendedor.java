 ...
 * @author david
 */
public class VentanaReporteXIdVendedor extends javax.swing.JDialog {

    /**
     * Creates new form VentanaReporteVendedor
     */
    public VentanaReporteXIdVendedor(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaReporteXIdVendedor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                VentanaReporteXIdVendedor dialog = new VentanaReporteXIdVendedor(new javax.swing.JFrame(), true);
