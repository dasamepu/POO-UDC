 ...
 */
package co.edu.ude.poo.empresas.vistas.gui.reportes.area;
 ...
 * @author david
 */
public class VentanaReporteXNombreArea extends javax.swing.JDialog {

    /**
     * Creates new form VentanaReporteArea
     */
    public VentanaReporteXNombreArea(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        Collections.sort(listaAreas, new Comparator<Area>() {
            @Override
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaReporteXNombreArea.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                VentanaReporteXNombreArea dialog = new VentanaReporteXNombreArea(new javax.swing.JFrame(), true);
