...
public class VentanaReporteArea extends javax.swing.JDialog {
     ...
     */
    public VentanaReporteArea(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaReporteArea.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                VentanaReporteArea dialog = new VentanaReporteArea(new javax.swing.JFrame(), true);
