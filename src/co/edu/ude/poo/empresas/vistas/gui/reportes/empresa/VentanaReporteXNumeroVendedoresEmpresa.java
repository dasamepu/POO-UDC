 ...
 * @author david
 */
public class VentanaReporteXNumeroVendedoresEmpresa extends javax.swing.JDialog {

    /**
     * Creates new form VentanaReporteEmpresa
     */
    public VentanaReporteXNumeroVendedoresEmpresa(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaReporteXNumeroVendedoresEmpresa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                VentanaReporteXNumeroVendedoresEmpresa dialog = new VentanaReporteXNumeroVendedoresEmpresa(new javax.swing.JFrame(), true);
