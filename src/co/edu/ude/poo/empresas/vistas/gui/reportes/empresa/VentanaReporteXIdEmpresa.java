 ...
 * @author david
 */
public class VentanaReporteXIdEmpresa extends javax.swing.JDialog {

    /**
     * Creates new form VentanaReporteEmpresa
     */
    public VentanaReporteXIdEmpresa(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaReporteXIdEmpresa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                VentanaReporteXIdEmpresa dialog = new VentanaReporteXIdEmpresa(new javax.swing.JFrame(), true);
